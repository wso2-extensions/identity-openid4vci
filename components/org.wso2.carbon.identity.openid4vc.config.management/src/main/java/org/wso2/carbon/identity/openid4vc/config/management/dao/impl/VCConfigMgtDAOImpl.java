...
package org.wso2.carbon.identity.openid4vc.config.management.dao.impl;

import org.apache.commons.collections.CollectionUtils;
import org.wso2.carbon.identity.core.model.ExpressionNode;
import org.wso2.carbon.identity.core.util.IdentityDatabaseUtil;
import org.wso2.carbon.identity.openid4vc.config.management.constant.SQLConstants;
...
import org.wso2.carbon.identity.openid4vc.config.management.util.VCConfigFilterQueryBuilder;
...
import static org.wso2.carbon.identity.openid4vc.config.management.constant.VCConfigManagementConstants.AFTER;
import static org.wso2.carbon.identity.openid4vc.config.management.constant.VCConfigManagementConstants.BEFORE;
    ...
    public VCCredentialConfiguration add(VCCredentialConfiguration configuration, int tenantId)
        ...
        try (Connection conn = IdentityDatabaseUtil.getDBConnection(true);
            ...
            try {
                ...
                ps.setString(6, configuration.getSigningAlgorithm());
                ...
                throw new VCConfigMgtServerException(
                        VCConfigManagementConstants.ErrorMessages.ERROR_CODE_TRANSACTION_ERROR.getCode(),
                        VCConfigManagementConstants.ErrorMessages.ERROR_CODE_TRANSACTION_ERROR.getMessage(), e);
            }
        } catch (SQLException e) {
            throw new VCConfigMgtServerException(
    ...
    public VCCredentialConfiguration update(String id, VCCredentialConfiguration configuration, int tenantId)
        ...
        try (Connection conn = IdentityDatabaseUtil.getDBConnection(true);
            ...
            try {
                ...
                ps.setString(3, configuration.getFormat());
                ps.setString(4, configuration.getSigningAlgorithm());
                ps.setInt(5, configuration.getExpiresIn());
                ps.setString(6, configuration.getOfferId());
